 ...
 */
final class Version20250114092605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO user (email, roles, password) VALUES ("admin@example.com", \'["ROLE_ADMIN"]\', "hashed_password")');
        $this->addSql('SET @admin_id = LAST_INSERT_ID();');
